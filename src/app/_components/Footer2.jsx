                    ...
                    <div className="container footer-top">
                        <div className="row gy-2">
                            <div className="col-lg-4 col-md-6 footer-about"> <Link href="/" className="logo d-flex align-items-center">
                                ...
                                <div className="social-links d-flex mt-4"> <Link href="#"><i className="bi bi-twitter-x twitter"></i></Link> <Link
                                    href="#"><i className="bi bi-facebook facebook"></i></Link> <Link href="#"><i
                                        className="bi bi-instagram instagram"></i></Link> <Link href="#"><i className="bi bi-linkedin linkedin"></i></Link>
                                </div>
                            </div>
