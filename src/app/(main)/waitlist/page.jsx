        ...
        <div className="main">
          <section className="waitlist-1">
            <div className="container">
              <div className="row">
                <div
                  className="col-lg-5 col-md-5 col-12 contact"
                ...
                <div className="col-lg-7 col-md-7 col-12">
                  <div className="wait-text">
                    ...
                    <h5 data-aos="zoom-in-right" data-aos-duration="3000">
                      Is YBF Business & Networking Forum for me ?
                    </h5>
                    <ol
                      data-aos="fade-left"
                      data-aos-offset="300"
                      data-aos-easing="ease-in-sine"
                    >
                      <li>Do you have reliable support system in place?</li>
                      <li>
                        Do you feel like you have all the knowledge and
                        potential yet you feel Stuck?
                      </li>
                      <li>Do you feel like you don’t know where to begin?</li>
                      <li>
                        Do you have Right funding and collaboration
                        opportunities?
                      </li>
                      <li>
                        Do you have great networking opportunities and right
                    ...
                    <div className="mt-5">
                      ...
                      >
                        ...
                        <li>
                          People feel stuck, stagnant, and unable to take the
                          next step in their careers or business.
                        </li>
                        <li>
                          Absence of support can lead to self-doubt and lack of
                          motivation.
                        </li>
                        <li>
                          Lack of meaningful networking opportunities with
                          like-minded people can create a sense of isolation and
                          depression.
                        </li>
                        <li>
                          Absence of the right guidance at the right time.
                        </li>
                      </ol>
                    </div>
                  </div>
